...
if ( ! class_exists( 'TVC_Survey' ) ) {	
	class TVC_Survey {
		...
		public function __construct( $name = '', $plugin = '' ){
			...
			add_action( 'admin_footer', array( $this, 'tvc_js'    ), 20 );
			add_action( 'admin_footer', array( $this, 'tvc_css'   )     );
			...
			<div class="ee-survey-modal" id="ee-survey-<?php echo esc_html($this->plugin); ?>">
				<div class="ee-survey-wrap">
					<form class="ee-survey" method="post">
						<span class="ee-survey-title"><?php echo ' ' . esc_html__( 'We appreciate your feedback on how we can improve.', 'server-side-tagging-via-google-tag-manager-for-wordpress' ); ?></span>
						<div class="feedback-reasons">
							<div tabindex="0" class="feedback-reason" onclick="selectReason(this)" data-question="<?php esc_html_e('Which plugin are you considering?', 'server-side-tagging-via-google-tag-manager-for-wordpress') ?>">
								<span class="dashicons dashicons-search"></span>
								<p><?php esc_html_e('Found a better Plugin', 'server-side-tagging-via-google-tag-manager-for-wordpress') ?></p>
							</div>
							<div tabindex="0" class="feedback-reason" onclick="selectReason(this)" data-question='<?php esc_html_e("Could you please share more information about the limitations you are experiencing with the product?", 'server-side-tagging-via-google-tag-manager-for-wordpress') ?>'>
								<span class="dashicons dashicons-products"></span>
								<p><?php esc_html_e('Product Limit', 'server-side-tagging-via-google-tag-manager-for-wordpress') ?></p>
							</div>
							<div tabindex="0" class="feedback-reason" onclick="selectReason(this)" data-question="<?php esc_html_e("Please provide us with some information of what you didn't understand", 'server-side-tagging-via-google-tag-manager-for-wordpress') ?>">
								<span class="dashicons dashicons-editor-help"></span>
								<p><?php esc_html_e("Couldn't Understand", 'server-side-tagging-via-google-tag-manager-for-wordpress') ?></p>
							</div>
							<div tabindex="0" class="feedback-reason" onclick="selectReason(this)" data-question="<?php esc_html_e('Could you provide some details about the specific feature that is absent in the product? (It will help us to improve our product)', 'server-side-tagging-via-google-tag-manager-for-wordpress') ?>">
								<span class="dashicons dashicons-admin-generic"></span>
								<p><?php esc_html_e('Missing a Specific Feature', 'server-side-tagging-via-google-tag-manager-for-wordpress') ?></p>
							</div>
							<div tabindex="0" class="feedback-reason" onclick="selectReason(this)" data-question="<?php esc_html_e('Could you kindly elaborate on the issue you experienced?', 'server-side-tagging-via-google-tag-manager-for-wordpress') ?>">
								<span class="dashicons dashicons-warning"></span>
								<p><?php esc_html_e('Bugs', 'server-side-tagging-via-google-tag-manager-for-wordpress') ?></p>
							</div>
						</div>
						...
						<p class="description text-danger mt-3"><span style="color:red">*</span><?php esc_html_e("Please, select one reason and submit.", 'server-side-tagging-via-google-tag-manager-for-wordpress') ?></p>
