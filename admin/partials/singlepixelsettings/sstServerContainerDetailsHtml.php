...
<!-- sst server container detail view modal -->
<div class="modal fade" id="serverContainerDetailModal" tabindex="-1" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog importContainerDetail modal-dialog-centered modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="serverContainerDetailModalLabel">Import Server Container</h5>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="" style="width: 20%;">
                        <div class="card p-0">
                            <h5 class="card-header clients-header conv-pink-bg conv-text-white m-0 conv-d-flex conv-justify-space-between fw-bold-600">Clients<span class="material-symbols-outlined conv-font-22">
                                    label
                                </span></h5>
                            <div class="card-body">
                                <div class="row">
                                    <div class="gtm-container-import-entity-body">
                                        <div class="row conv-text-center">
                                            <div class="col-md-3 p-0">
                                                <div class="blg-subhead server-client-count"> </div>
                                            </div>
                                ...
                                <div class="row pt-3">
                                    <div class="collapse collapseExample">
                                        <div class="gtm-container-import-detail" aria-hidden="false">
                                            ...
                                            <div class="gtm-container-import-detail-separator conv-b-grey"></div> <!---->
                                            <div class="server-client-list pt-2">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="gtm-container-import-entity-body">
                                        <div class="row conv-text-center">
                                            <div class="col-md-3 p-0">
                                                <div class="blg-subhead server-tag-count"> </div>
                                            </div>
                                            <div class="col-md-5 p-0">
                                                <div class="blg-subhead ">0 </div>
                                            </div>
                                ...
                                <div class="row pt-3">
                                    <div class="collapse collapseExample">
                                        <div class="gtm-container-import-detail" aria-hidden="false">
                                            ...
                                            <div class="blg-body-med fw-bold-600"> New tags </div>
                                            <div class="gtm-container-import-detail-separator conv-b-grey"></div> <!---->
                                            <div class="server-tag-list pt-2">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="gtm-container-import-entity-body">
                                        <div class="row conv-text-center">
                                            <div class="col-md-3 p-0">
                                                <div class="blg-subhead server-trigger-count"> </div>
                                            </div>
                                            <div class="col-md-5 p-0">
                                                <div class="blg-subhead">0 </div>
                                            </div>
                                ...
                                <div class="row pt-3">
                                    <div class="collapse collapseExample">
                                        <div class="gtm-container-import-detail" aria-hidden="false">
                                            ...
                                            <div class="gtm-container-import-detail-separator conv-b-grey"></div>
                                            <div class="server-trigger-list pt-2">
                    ...
                    <div class="" style="width: 20%;">
                        <div class="card p-0">
                            <?php if ( ! defined( 'ABSPATH' ) ) exit; // Exit if accessed directly ?>
                            <h5 class="card-header variables-header conv-orange-bg conv-text-white m-0 conv-d-flex conv-justify-space-between fw-bold-600">Variables<img src="<?php echo esc_url(CONVSST_PLUGIN_URL . '/admin/images/icon/variables.png'); ?>" /></h5>
                            <div class="card-body">
                                <div class="row">
                                    <div class="gtm-container-import-entity-body">
                                        <div class="row conv-text-center">
                                            <div class="col-md-3 p-0">
                                                <div class="blg-subhead server-variable-count"> 48 </div>
                                            </div>
                                            <div class="col-md-5 p-0">
                                                <div class="blg-subhead">0 </div>
                                            </div>
                                ...
                                <div class="row pt-3">
                                    <div class="collapse collapseExample">
                                        <div class="gtm-container-import-detail" aria-hidden="false">
                                            ...
                                            <div class="gtm-container-import-detail-separator conv-b-grey"></div>
                                            <div class="server-variable-list pt-2">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="gtm-container-import-entity-body">
                                        <div class="row conv-text-center">
                                            <div class="col-md-3 p-0">
                                                <div class="blg-subhead server-template-count"> 7 </div>
                                            </div>
                                            <div class="col-md-5 p-0">
                                                <div class="blg-subhead"> 0 </div>
                                            </div>
                                ...
                                <div class="row pt-3">
                                    <div class="collapse collapseExample">
                                        <div class="gtm-container-import-detail" aria-hidden="false">
                                            ...
                                            <div class="gtm-container-import-detail-separator conv-b-grey"></div>
                                            <div class="server-customTemplate-list pt-2">
