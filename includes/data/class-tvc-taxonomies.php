...
if ( ! class_exists( 'CONVSST_Taxonomies' ) ) :

    /**
     * Taxonomies Class
     */
    class CONVSST_Taxonomies {
        ...
        public static function get_shop_categories_list() {
            $args = array(
                ...
                'orderby'      => 'name',
                'order'        => 'ASC',
                'exclude'      => apply_filters( 'convsst_category_mapping_exclude', array() ),
                'exclude_tree' => apply_filters( 'convsst_category_mapping_exclude_tree', array() ),
                'number'       => absint( apply_filters( 'convsst_category_mapping_max_categories', 0 ) ),
                'child_of'     => 0,
            );

            $args = apply_filters( 'convsst_category_mapping_args', $args );
    ...
    // end of CONVSST_Taxonomies_Class
